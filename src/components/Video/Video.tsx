  ...
  if (loading)
    return (
      <div className="flex-1 flex justify-center bg-black">
        <div className="h-full w-full max-w-[1100px] max-h-[60vh] aspect-video bg-gray-300 animate-pulse" />
      </div>
    );

  if (error)
    return (
      <div className="flex-1 flex flex-col gap-5 items-center px-6">
        <ReactIcon className="w-24 h-24 mt-20 animate-spin-slow fill-blue-500" />
        <p className="text-xl font-bold">
          There was an error loading this lesson.
        </p>
      </div>
    );
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-8 mt-12 sm:mt-20">
              ...
              >
                ...
                <div className="py-6 leading-relaxed flex-1">
                  <strong className="text-xl xs:text-2xl">Lesson files</strong>
                  <p className="text-sm text-gray-200 mt-2">
                    Get the documents and exercises from this lesson to improve
                    your knowledge
                  </p>
                </div>
